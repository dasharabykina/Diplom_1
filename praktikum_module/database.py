...
from praktikum_module.bun import Bun
from praktikum_module.ingredient import Ingredient
from praktikum_module.ingredient_types import INGREDIENT_TYPE_SAUCE, INGREDIENT_TYPE_FILLING
